...
#    name = cms.untracked.string('$Source: /local/reps/CMSSW/UserCode/sdooling/NP_CORRECTIONS/cfg_files/TuneZ2_7TeV.py,v $')
#)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MinBias_TuneZ2_2p76TeV_pythia6_cff_py_GEN_test.root'),
